                                   ...
                                   enum CREncoding a_encoding)
{
        ...
        parser = cr_parser_new_from_buf ((guchar*)a_buf, strlen ((const gchar*)a_buf),
                                         a_encoding, FALSE);
...
cr_term_to_string (CRTerm * a_this)
{
        ...
        for (cur = a_this; cur; cur = cur->next) {
                ...
                case TERM_FUNCTION:
                        if (cur->content.str) {
                                content = g_strndup
                                        ((const gchar*)cur->content.str->stryng->str,
                        ...
                        if (content) {
                                ...
                                if (cur->ext_content.func_param) {
                                        ...
                                        tmp_str = (gchar*)cr_term_to_string
                                                (cur->
                ...
                case TERM_RGB:
                        if (cur->content.rgb) {
                                ...
                                tmp_str = (gchar *)cr_rgb_to_string (cur->content.rgb);
...
cr_term_one_to_string (CRTerm * a_this)
{
        ...
        case TERM_FUNCTION:
                if (a_this->content.str) {
                        content = g_strndup
                                ((const gchar*)a_this->content.str->stryng->str,
        ...
        case TERM_RGB:
                if (a_this->content.rgb) {
                        ...
                        tmp_str = (gchar*)cr_rgb_to_string (a_this->content.rgb);
