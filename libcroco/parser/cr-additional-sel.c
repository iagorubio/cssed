                ...
                case CLASS_ADD_SELECTOR:
                        {
                                ...
                                if (cur->content.class_name) {
                                        name = g_strndup
                                                ((const gchar*)cur->content.class_name->stryng->str,
                ...
                case ID_ADD_SELECTOR:
                        {
                                ...
                                if (cur->content.class_name) {
                                        name = g_strndup
                                                ((const gchar*)cur->content.id_name->stryng->str,
...
cr_additional_sel_one_to_string (CRAdditionalSel *a_this)
{
        ...
        case CLASS_ADD_SELECTOR:
        {
                ...
                if (a_this->content.class_name) {
                        name = g_strndup
                                ((const gchar*)a_this->content.class_name->stryng->str,
        ...
        case ID_ADD_SELECTOR:
        {
                ...
                if (a_this->content.class_name) {
                        name = g_strndup
                                ((const gchar*)a_this->content.id_name->stryng->str,
