...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(srcdir)/cssed.pc.in $(top_srcdir)/configure \
	$(top_srcdir)/freedesktop/cssed.applications.in \
	$(top_srcdir)/freedesktop/cssed.desktop.in AUTHORS COPYING \
	ChangeLog INSTALL NEWS acconfig.h config.guess config.rpath \
...
CONFIG_CLEAN_FILES = cssed.pc freedesktop/cssed.applications \
...
abs_builddir = /home/iago/files/projects/sf/cssed/cssed
abs_srcdir = /home/iago/files/projects/sf/cssed/cssed
...
cssed.pc: $(top_builddir)/config.status $(srcdir)/cssed.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
freedesktop/cssed.applications: $(top_builddir)/config.status $(top_srcdir)/freedesktop/cssed.applications.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
freedesktop/cssed.desktop: $(top_builddir)/config.status $(top_srcdir)/freedesktop/cssed.desktop.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
install-data-am: install-data-local install-man install-pkgconfigDATA
...
uninstall-am: uninstall-local uninstall-man uninstall-pkgconfigDATA
